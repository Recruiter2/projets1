...
<table>
    <tr>
        ...
        <td class="td-search" colspan="3">
            <form action = "." method = "post" class="zonerch">
                <input type="hidden" name="action" value="rech">
                <input type="search" name="valrecherche" placeholder="rechercher un media ..." class="cnx-control" id="barrech"
...
<ul>
    <li>
        <span class="header-user">
                 ...
                 <?php echo isset($_SESSION["username"])?$_SESSION["username"]:"visiteur";?>
            </span>
    </li>
